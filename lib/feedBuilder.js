...
const xmlPropertiesMap = {
    ...
    imageLink: {
        xmlName: 'g:image_link'
    },
    mobileLink: {
        xmlName: 'g:mobile_link'
    },
    additionalImageLink: {
    ...
    price: {
        xmlName: 'g:price',
        xmlFormatter: xmlPriceFormatter
    },
    salePrice: {
        xmlName: 'g:sale_price',
        xmlFormatter: xmlPriceFormatter
    },
    salePriceEffectiveDate: {
        xmlName: 'g:sale_price_effective_date',
        xmlFormatter: xmlDateRangeFormatter
    },
    costOfGoodsSold: {
    ...
    unitPricingMeasure: {
        ...
        xmlFormatter: xmlValueUnitNoSpaceFormatter
    },
    ...
    googleProductCategory: {
        xmlName: 'g:google_product_category'
    },
    productType: {
        xmlName: 'g:product_type',
        allowRepeat: true
    },
    brand: {
        xmlName: 'g:brand'
    ...
    energyEfficiencyClass: {
        xmlName: 'g:energy_efficiency_class'
    },
    // TODO: error in spec
    minEnergyEfficiencyClass: {
        xmlName: 'g:min_energy_efficiency_class'
    },
    maxEnergyEfficiencyClass: {
        xmlName: 'g:max_energy_efficiency_class'
    },
    ageGroup: {
        xmlName: 'g:age_group'
    },
    ...
    sizeSystem: {
        xmlName: 'g:size_system'
    },
    itemGroupId: {
        xmlName: 'g:item_group_id'
    },
    adwordsRedirect: {
        xmlName: 'g:ads_redirect'
    },
    customLabels: {
        xmlFormatter: xmlCustomLabelsFormatter
    },
    promotionId: {
        xmlName: 'g:promotion_id',
        allowRepeat: true
    },
    // TODO: error in spec
    includedDestination: {
        xmlName: 'g:included_destination',
        allowRepeat: true
    },
    excludedDestination: {
        xmlName: 'g:excluded_destination',
        allowRepeat: true
    },
    shipping: {
        xmlName: 'g:shipping',
        ...
        items: {
            ...
            postalCode: {
                xmlName: 'g:postal_code'
            },
            locationId: {
                xmlName: 'g:location_id'
            },
            locationGroupName: {
                xmlName: 'g:location_group_name'
            },
            service: {
                xmlName: 'g:service'
            },
    ...
    shippingLabel: {
        xmlName: 'g:shipping_label'
    },
    // TODO: error in spec. Space?
    shippingWeight: {
        xmlName: 'g:shipping_weight',
        xmlFormatter: xmlValueUnitFormatter
    },
    shippingLength: {
    ...
    minHandlingTime: {
        xmlName: 'g:min_handling_time'
    },
    maxHandlingTime: {
        xmlName: 'g:max_handling_time'
    },
    tax: {
        xmlName: 'g:tax',
        xmlFormatter: xmlObjectFormatter,
        ...
        items: {
            ...
            rate: {
                xmlName: 'g:rate',
                xmlFormatter: xmlFixedNumberFormatBuilder(2)
            },
            taxShip: {
                xmlName: 'g:tax_ship',
                xmlFormatter: xmlYesNoFormatter
            }
        }
    },
    taxCategory: {
        xmlName: 'g:tax_category'
    }
};
...
module.exports = class {
    ...
    buildXml() {
        ...
        const xml = xmlbuilder.create(feed, {
            encoding: 'utf-8'
        });
        return xml.end({
            pretty: true
